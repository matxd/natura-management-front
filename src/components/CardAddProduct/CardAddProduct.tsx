...
export const CardAddProduct = () => {
  ...
  return (
    <>
      ...
      <Box sx={{ border: '3px solid #efebed', borderRadius: '5px', backgroundColor: '#efebed', color: '#000', display: 'flex', flexDirection: 'column', flexWrap: 'wrap', width: '250px', height: '321px', justifyContent: 'center', alignItems: 'center' }}>
